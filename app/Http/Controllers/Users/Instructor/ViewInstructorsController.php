...
class ViewInstructorsController extends Controller
{
    ...
    function adduser($request) {
        ...
        $add_new_user->name=strtoupper($request->name);
    ...
    function addinstructorinfo($request) {
        ...
        $add_info->name=strtoupper($request->name);
        ...
        $add_info->designation_type = $request->designation_type;
        if($add_info->employee_type=='Full Time')
        {
            if($add_info->designation_type=='Professor')
            {
                $add_info->credit=12;
            }
            if($add_info->designation_type=='Assistant Professor')
            {
                $add_info->credit=16;
            }
            if($add_info->designation_type=='Associate Professor')
            {
                $add_info->credit=14;
            }
            else{
...
//        $updateinfo->province = $request->province;
        ...
        $updateinfo->designation_type = $request->designation_type;
