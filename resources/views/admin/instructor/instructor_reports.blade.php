...
<section class="content">
    <div class="container-fluid">
        <div class="box box-default">
            <div class="box-header"><h5 class="box-title">List of Instructors</h5>
            </div>
                <div class="box-body">
                    <div>
                  ...
                  <th width="15%">Course Loading</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{strtoupper($instructor->name)}}</td>
                                <?php $info = \App\instructors_infos::where('instructor_id',$instructor->id)->first();?>
                                    <td>{{$info->department}}</td>
                                    <td><a href="{{url('/admin/instructor/edit_faculty_loading',array($instructor->id))}}" class="btn btn-flat btn-success"><i class="fa fa-eye"></i></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
