...
<div class="box box-default">
    <div class="box-header">
        ...
        <div class="box-tools pull-right">
         <a href="/instructor/faculty_loading/print_semester_occupied/{{$offered_to}}/{{$program_code}}/{{$period}}" class="btn btn-flat btn-primary"><i class="fa fa-print"></i> Generate PDF</a>
        </div>
    </div>
    <div class="box-body">
