...
//semester view
Route::get('/instructor/semester_occupied','Instructor\FacultyLoading@semester_occupied');
Route::get('/ajax/instructor/faculty_loading/get_semester_occupied','Instructor\Ajax\FacultyLoadingAjax@get_semester_occupied');
Route::get('/instructor/faculty_loading/print_semester_occupied/{offered_to}/{program_code}/{period}','Instructor\Ajax\FacultyLoadingAjax@print_semester_occupied');
Route::get('/instructor/faculty_loading/print_self_course/{instructor}','Instructor\Ajax\FacultyLoadingAjax@print_self_course');
...
Route::get('/admin/edit_faculty_loading','Admin\FacultyLoadingController@editfaculty_loading');
Route::get('/ajax/admin/faculty_loading/courses_to_load','Admin\Ajax\FacultyLoadingAjax@courses_to_load');

Route::post('/admin/faculty_loading/assignTeachers', 'Admin\FacultyLoadingController@assignTeachers');

Route::get('/ajax/admin/faculty_loading/course_mngt','Admin\Ajax\FacultyLoadingAjax@course_mngt');

 Route::get('/ajax/admin/faculty_loading/course_assign','Admin\Ajax\FacultyLoadingAjax@course_assign');

  Route::get('/ajax/admin/faculty_loading/edit_modal','Admin\Ajax\FacultyLoadingAjax@edit_modal');
...
Route::get('/admin/instructor/print_instructor/{instructor}','Admin\Ajax\FacultyLoadingAjax@print_instructor');
...
//Courses List
Route::get('/ajax/admin/faculty_loading/courses_lists','Admin\Ajax\FacultyLoadingAjax@courses_lists');
Route::get('/ajax/admin/faculty_loading/edit_load','Admin\Ajax\FacultyLoadingAjax@edit_load');
Route::post('/ajax/admin/faculty_loading/update_load','Admin\FacultyLoadingController@update_load');
...
Route::get('/admin/reports/print_rooms_occupied/{offered_to}/{program_code}/{period}','Admin\ReportController@print_room_occupied');
